        ...
        <fieldset key={control.id} className="control">
          ...
          {control.type === 'toggle' && (
            <button
              ...
              // The visible "On"/"Off" text must appear in the accessible
              // name, or voice control cannot target the button by what it
              // says (WCAG 2.5.3, Label in Name).
              aria-label={`${control.label}: ${value[control.id] ? 'On' : 'Off'}`}
